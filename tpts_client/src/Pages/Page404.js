...
import GGvert from "../Media/Logos/GGB.png"
import GGrouge from "../Media/Logos/GGR.png"
import GGbleu from "../Media/Logos/GGV.png"
...
<div class="errorPageRap">
  <div class="holoContainer">
    ...
    <img src={GGrouge}/>
    <img src={GGvert}/>
    <svg class="holoPad" width="25.6rem" height="27.8rem" viewBox="0 0 226 242" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                <defs>
                            ...
                            <g id="base" transform="translate(0.000000, 141.000000)">
                                ...
                                <g id="holo_ring_lense" transform="translate(9.000000, 3.000000)">
                                    ...
                                    <g id="Oval-2">
                                        ...
                                        <use fill="#D3F9FD" fill-rule="evenodd" xlinkHref="#path-5"></use>
                                    </g>
  ...
  <h1>
  <strong>Hé lala... La page existe pas mon pitou. </strong><span><img src="http://danielwolf.cc/codepen/errorpage/sadFace.png"/></span>
            <br/>
            <strong>Tu devrais peut-être revenir au Menu Principal.</strong>
        </h1>
</div>
